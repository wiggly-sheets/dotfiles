...
# Run ./set-defaults.sh to execute
...
# square corner radii for windows
defaults write -g NSConvolutionOverride1 -float 0.1

# disable Tahoe's floating sidebar
...
defaults write com.apple.WindowManager AnimationSpeed -float 100
