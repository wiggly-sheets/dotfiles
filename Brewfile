...
vscode "ericsia.pythonsnippets3pro"
...
vscode "kevingamer3d2.selene-vscode"
...
vscode "python-beautifier.python-beautifier"
vscode "redhat.vscode-yaml"
vscode "sceleratis.extra-dark-modern"
vscode "sumneko.lua"
vscode "tombonnike.vscode-status-bar-format-toggle"
vscode "urin.vscode-web-visual-editor"
vscode "usernamehw.errorlens"
vscode "venage5603.tokyo-night-dark-enhanced"
